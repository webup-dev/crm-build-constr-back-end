 ...
 * @mixin \Eloquent
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Requester[] $requesters
 */
class Organization extends Model
{
    ...
    /**
     * Organization - requester: one-to-many
     *
     * Get the requesters of the Organization.
     *
     * @return HasMany
     */
